...
export const metadata: Metadata = {
  title: 'تنظيف المنازل والفلل بالرياض | اتصل 0575386029 | شركة أجواء',
  description: 'خدمة تنظيف المنازل والفلل الشاملة في الرياض من شركة أجواء. تنظيف عميق، تعقيم، جلي رخام بأحدث المعدات. اتصل الآن: 0575386029',
  keywords: 'تنظيف منازل بالرياض, تنظيف فلل بالرياض, شركة تنظيف منازل الرياض, جلي رخام الرياض, تنظيف شقق بالرياض, غسيل كنب ومجالس, تنظيف واجهات منازل, رقم شركة تنظيف 0575386029, 0575386029',
  alternates: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'تنظيف منازل وفلل بالرياض - 0575386029',
      }
    ],
  },
  twitter: {
...
export default function TanzifManazilPage() {
  ...
  return (
    <article className="pb-20">
      <TikTokTracker
        contentId="service-tanzif-manazil"
        contentType="product"
        contentName="خدمة تنظيف المنازل والفلل بالرياض"
        value={299}
        currency="SAR"
      />
      <script
