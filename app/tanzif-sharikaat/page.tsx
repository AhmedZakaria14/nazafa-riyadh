...
export const metadata: Metadata = {
  title: 'تنظيف الشركات والمكاتب بالرياض | اتصل 0575386029 | شركة أجواء',
  description: 'خدمة تنظيف الشركات والمكاتب الاحترافية بالرياض من شركة أجواء. تعقيم وتنظيف يومي وأسبوعي. اتصل بنا: 0575386029',
  keywords: 'تنظيف شركات الرياض, تنظيف مكاتب بالرياض, شركة تنظيف مؤسسات, تعقيم مكاتب, تنظيف مستودعات, تنظيف معارض بالرياض, عقود تنظيف شركات, رقم شركة تنظيف 0575386029, 0575386029',
  alternates: {
    canonical: 'https://cleanajwa.com/tanzif-sharikaat',
  },
  openGraph: {
    title: 'تنظيف الشركات والمكاتب بالرياض | اتصل: 0575386029 | شركة أجواء',
    description: 'خدمة تنظيف الشركات والمكاتب الاحترافية بالرياض من شركة أجواء. تعقيم وتنظيف يومي وأسبوعي. اتصل: 0575386029',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'تنظيف شركات ومكاتب بالرياض - 0575386029',
      }
    ],
  },
  twitter: {
...
export default function TanzifSharikaatPage() {
  ...
  return (
    <article className="pb-20">
      <TikTokTracker
        contentId="service-tanzif-sharikaat"
        contentType="product"
        contentName="خدمة تنظيف الشركات والمكاتب بالرياض"
        value={500}
        currency="SAR"
      />
      <script
