...
export const metadata: Metadata = {
  title: 'عروض وباقات تنظيف المنازل والفلل بالرياض تبدأ من 299 ريال | اتصل: 0575386029 | شركة أجواء',
  description: 'احصل على أقوى عروض تنظيف الشقق والفلل بالرياض تبدأ من 299 ريال من شركة أجواء. نظافة فندقية متكاملة بأحدث المعدات الألمانية وضمان 100%. احجز الآن عبر 0575386029.',
  keywords: [
    'تنظيف شقق 299 ريال',
    'تنظيف فلل 750 ريال',
    'تنظيف دور 350 ريال',
  ...
  openGraph: {
    title: 'عروض تنظيف شقق وفلل بالرياض تبدأ من 299 ريال | اتصل 0575386029 | شركة أجواء',
    description: 'تنظيف شقق بـ 299 ر.س، دور بـ 350 ر.س، وفلل بـ 750 ر.س مع ضمان الجودة الفندقية والمعاينة قبل الدفع. للحجز المباشر: 0575386029',
    ...
    images: [
      {
        ...
        width: 512,
        height: 512,
        alt: 'عروض تنظيف المنازل بالرياض - اتصل 0575386029 - شركة أجواء',
      },
    ],
  },
  twitter: {
    ...
    title: 'عروض تنظيف شقق وفلل بالرياض تبدأ من 299 ريال | اتصل 0575386029 | شركة أجواء',
    description: 'خدمة احترافية بأحدث المعدات الألمانية وضمان فندقي 100%. للحجز والاستفسار المباشر: 0575386029.',
      ...
      },
      {
        ...
        mainEntity: [
          ...
          },
          {
            ...
            acceptedAnswer: {
              '@type': 'Answer',
              text: 'لا نطلب أي دفع مسبق! يمكنك الحجز فوراً عبر الضغط على زر الواتساب أو الاتصال على 0575386029، وتأكيد الموعد المناسب لك، والدفع يكون بعد إتمام العمل ومعاينتك الميدانية.',
            },
          },
          {
            '@type': 'Question',
