        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            <li className="flex items-center gap-2">
              <span dir="ltr">0537106102</span> 📞
            </li>
            <li>
              <a href="https://api.whatsapp.com/send/?phone=966537106102" target="_blank" rel="noopener noreferrer" className="hover:text-green-400 transition-colors">
